...
public class MemberDAO {
	...
	//사용자 인증시 사용하는 메소드. 테이블에서 아이디와 암호를 비교해서 해당 아이디가 존재하지 않으면 -1, 아이디만 일치하고 암호가 다르면 0, 모두 일치하면 1 리턴함.
	...
	//회원가입 시 아이디 중복을 확인할 때 사용. 해당 아이디가 있으면 1, 없으면 -1리턴.
	...
	//매개 변수로 받은 VO 객체 내의 아이디로 member 테이블에서 검색해서 VO 객체에 저장된 정보로 회원 정보를 수정한다. 
